...
class AsyncOpenHttp(threading.Thread):
    ...
    def make_google_request(self, flac, requestId, dictation, language="zh-TW", allowCurses=True):
        if self.finished:
    ...
    def run(self):
        ...
        url = "https://www.google.com/speech-api/v1/recognize?xjerr=1&client=chromium&pfilter={0}&lang=zh-TW&maxresults=6".format(0 if self.allowCurses else 2, self.language)
